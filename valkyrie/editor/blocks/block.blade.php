                                ...
                                <form action="{{ route('join-form') }}" class="contact-form py-0" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <fieldset>
                                                <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control" style="width: 100%;" required />
                                            </fieldset>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label class="text-black">{{ __('Last name') }}</label>
                                            <fieldset>
                                                <input type="text" name="last_name" value="{{ old('last_name') }}" class="form-control" style="width: 100%;" required />
                                            </fieldset>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label class="text-black">{{ __('Login') }}</label>
                                            <fieldset>
                                                <input type="text" name="login" value="{{ old('login') }}" class="form-control" style="width: 100%;" required />
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            <button type="submit" class="btn btn-success btn-lg px-3">Submit Request</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
