                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="category">
                                                ...
                                                <ul class="list-unstyled pl-3">
                                                    <li class="mb-1">
                                                        <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['category' => '', 'page' => 1])) }}" @if (!request('category')) class="active" @endif>
                                                            All categories
                                                        </a>
                                                    </li>
                                                    @foreach($categories as $category)
                                                        <li class="mb-1">
                                                            <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['category' => $category->id, 'page' => 1])) }}" @if (request('category') == $category->id) class="active" @endif>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="category">
                                            ...
                                            <ul class="list-unstyled pl-3">
                                                <li class="mb-1">
                                                    <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['timeframe' => 0, 'page' => 1])) }}" @if (request('timeframe', settings('links_setup.default_timeframe', 0)) == 0) class="active" @endif>
                                                        All
                                                    </a>
                                                </li>
                                                <li class="mb-1">
                                                    <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['timeframe' => 1, 'page' => 1])) }}" @if (request('timeframe', settings('links_setup.default_timeframe', 0)) == 1) class="active" @endif>
                                                        1 month
                                                    </a>
                                                </li>
                                                <li class="mb-1">
                                                    <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['timeframe' => 3, 'page' => 1])) }}" @if (request('timeframe', settings('links_setup.default_timeframe', 0)) == 3) class="active" @endif>
                                                        3 month
                                                    </a>
                                                </li>
                                                <li class="mb-1">
                                                    <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['timeframe' => 6, 'page' => 1])) }}" @if (request('timeframe', settings('links_setup.default_timeframe', 0)) == 6) class="active" @endif>
                                                        6 month
                                                    </a>
                                                </li>
                                                <li class="mb-1">
                                                    <a class="text-decoration-none" href="{{ route('links.list', array_merge(array_filter(request()->query()), ['timeframe' => 12, 'page' => 1])) }}" @if (request('timeframe', settings('links_setup.default_timeframe', 0)) == 12) class="active" @endif>
                                                        12 month
                                                    </a>
                                                </li>
                                            </ul>
                        ...
                        <div class="col-lg-9">
                            @if (! empty($links))
                                ...
                                <div class="row">
                                    @if ($links->lastPage() > 1)
                                        {{ $links->onEachSide(2)->appends(request()->query())->links('vendor.pagination.valkyrie') }}
                                    @endif
                                </div>
                            @endif
                        </div>
