                                ...
                                <div class="post-item post3-item-style">
                                    ...
                                    <div class="content">
                                        <ul class="post-meta post3-meta">
                                            <li class="post-date"><span>Date:</span> {{ $post->created_at?->format('d F, y') ?? '' }}</li>
{{--                                            <li class="post-info">--}}
{{--                                                <ul class="d-flex">--}}
                                ...
                                <div class="post-item post3-item-style">
                                    ...
                                    <div class="content">
                                        <ul class="post-meta post3-meta pb-1">
                                            <li class="post-date">{{ $event->start_at?->format('d F, y') ?? '' }}</li>
                                            <li class="post-date">{{ $event->start_at?->format('H:i') ?? '' }}</li>
                                        </ul>
                                        <ul class="post-meta post3-meta pb-1">
                                            @if (($event->start_at?->format('d F, y') ?? '') != ($event->end_at?->format('d F, y') ?? ''))
                                                <li class="post-date">{{ $event->end_at?->format('d F, y') ?? '' }}</li>
                                            @endif
