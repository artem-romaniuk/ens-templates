<section class="services py-0">
    <div class="container row-block">
        <div class="row">
            @foreach($data['cols'] ?? [] as $col)
                @continue(empty($col['body']['blocks']))
                <div class="col-md-6 col-lg-{{ 12 / count(array_filter($data['cols'], fn ($item) => ! empty($item['body']['blocks']))) }} d-flex align-items-stretch" data-aos="fade-up">
