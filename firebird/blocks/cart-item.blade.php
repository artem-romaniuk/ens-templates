<section class="service_section mb-4" style="max-width: 100%; width: 100%;">
            ...
            <div class="row" style="min-height: 200px;">
                ...
                <div class="col-lg-4" style="text-align: right;">
                    ...
                    <form id="removeCartItem{{ $item->id }}" action="{{ route('store.cart.item.remove', $item->id) }}" method="POST">
                        ...
                        <a href="#" class="cta-btn custom-button" onclick="event.preventDefault(); document.getElementById('removeCartItem{{ $item->id }}').submit();">
                            Remove Item
                        </a>
                    </form>
                </div>
